...
$("#btrGuardarCambios").click(function){
                ...
                fetch("/Home/GuardarPerfil", {
                    ...
                    .then(responseJson => {
                        if (responseJson.estado) {
                            ...
                            swal("listo¡", "Los cambios se aplicaron", "sucess")
                        } else {
                            swal("Lo sentimos", responseJson.mensaje, "error")
                        }
                    })
...
$("#btnCambiarClave").click(function () {
    ...
    if ($("#txtClaveNueva").val().trim() != $("#txtClaveNueva").val().trim()) {
    ...
    fetch("/Home/CambiarClave", {
        ...
        .then(responseJson => {
            if (responseJson.estado) {
                ...
                swal("listo¡", "Su contraseña fue actualizada", "sucess")
